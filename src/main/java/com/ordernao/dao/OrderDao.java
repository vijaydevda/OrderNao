...
public class OrderDao {
	...
	// String query
	// =OrderNaoConstants.GET_DELIVERY_BOY_PAYMENT_DETAILS_FROM_ORDERS_TABLE;
	String query = "select dailytransaction.money_provided from dailytransaction where dailytransaction.user_id=? and DATE(dailytransaction.paymentdate)=current_date()";
	logger.info("Query :- " + query);
     ...
     * @return list of order bean which contain details of orders assigned to delivery boy
     */
