...
public class OrderDao {
	...
	public int checkForPendingOrDeliveredOrder(String orderNumber) {
	...
	public int saveFailedStatusCommentsOfOrder(String orderNumber, String failedComments) {
	...
	public int savePendingOrFailedOrderStatus(String orderNumber, String newStatusOfOrder) {
		logger.info("Entry at savePendingOrFailedOrderStatus(DAO)");
		String sqlQuery = property.getProperty(OrderNaoConstants.SAVE_PENDING_OR_FAILED_ORDER_STATUS);
		...
		logger.info("Exit at savePendingOrFailedOrderStatus(DAO) Result :- " + result);
		return result;
	}
